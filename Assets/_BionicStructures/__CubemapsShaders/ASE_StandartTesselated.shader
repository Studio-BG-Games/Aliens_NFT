...
Shader "ASE/ASE_StandartTesselated"
{
	Properties
	{
		...
		_HeightOffset("HeightOffset", Float) = 0.001
		_Snoothness("Snoothness", Float) = 1
		_Metallic("Metallic", Float) = 1
		_NormalMapDepth("NormalMapDepth", Float) = 1
		_Tiling("Tiling", Float) = 1
		[ASEEnd]_MetalicBrightnes("MetalicBrightnes", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord17 = inputMesh.ase_texcoord.xy * temp_cast_0 + float2( 0,0 );
				...
				#endif
				float3 vertexValue = ( ( tex2Dlod( _HeightMap, float4( texCoord17, 0, 0.0) ).r * inputMesh.normalOS ) * _HeightOffset );
						...
						)
			{
				...
				float4 temp_output_3_0 = ( tex2D( _Albedo, texCoord17 ) * _AlbedoColor );
				
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, texCoord17 ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				
				float4 tex2DNode5 = tex2D( _MetallicMap, texCoord17 );
				float3 linearToGamma105 = FastLinearToSRGB( tex2DNode5.rgb );
				float lerpResult93 = lerp( linearToGamma105.x , 1.0 , _MetalicBrightnes);
				
				float4 tex2DNode33 = tex2D( _EmissionMap, texCoord17 );
				
				float3 linearToGamma103 = FastLinearToSRGB( tex2D( _SmoothnessMap, texCoord17 ).rgb );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord17 = inputMesh.uv0.xy * temp_cast_0 + float2( 0,0 );
...
/*ASEBEGIN
Version=18712
324.6667;184.6667;1514.667;1086.333;401.256;524.7216;1.219042;True;False
Node;AmplifyShaderEditor.RangedFloatNode;67;-2068.761,-792.963;Float;False;Property;_Tiling;Tiling;16;0;Create;True;0;0;0;False;0;False;1;1.71;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;17;-1739.567,-925.5715;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;6;-1961.9,260.7534;Inherit;True;Property;_SmoothnessMap;SmoothnessMap;9;0;Create;True;0;0;0;False;0;False;-1;None;371f177f72c81254ba8cf11577ff3f82;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-403.4567,-799.6359;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;-1;None;99d851c133fb0614592cc09413c42b7b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.NormalVertexDataNode;119;294.8158,53.1044;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;118;217.8697,-185.9708;Inherit;True;Property;_HeightMap;HeightMap;10;0;Create;True;0;0;0;False;0;False;-1;None;38f4e32d0db972740b0dd0418b09c79f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;448.0252,277.9772;Float;False;Property;_HeightOffset;HeightOffset;12;0;Create;True;0;0;0;False;0;False;0.001;0.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;120;576.4145,-74.89512;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-461.2012,333.9779;Float;False;Property;_Snoothness;Snoothness;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;63;693.1497,48.51306;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-1234.694,-697.3605;Inherit;True;Property;_NormalMap;NormalMap;5;0;Create;True;0;0;0;False;0;False;-1;None;9c34d8c47fc2ba34ba1acfc8c2371cce;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;107;11;63;0
ASEEND*/
//CHKSM=97435D0EDE4B0AF21227166F7BAA45BAC34B2B0C